...
export const STEM_SIMULATIONS: SimulationItem[] = [
  {
    ...
    learningObjectives: [
      ...
      "Evaluate algebraic substitution of x-values into quadratic form y = ax¬≤ + bx + c and linear form y = mx + k",
    ...
    previewFacts: [
      ...
      "The x-coordinates of the intersection points are roots of the combined quadratic equation (a)x¬≤ + (b - m)x + (c - k) = 0."
    ],
    isHtmlApp: true,
  ...
  },
  {
    ...
    previewFacts: [
      "Saturn is the least dense planet in the Solar System‚Äîwith an average density of ~0.687 g/cm¬≥, it is less dense than water.",
  ...
  },
  {
    ...
    tagline: "Interactive 3D orbital dynamics demonstrating elliptical orbits, equal-time swept area sectors, and harmonic period ratios (T¬≤ ‚àù a¬≥)",
    discipline: "physics",
    gradeLevel: ["Middle School (6-8)", "High School (9-12)", "AP / IB STEM", "Undergraduate"],
    ...
    previewFacts: [
      ...
      "Kepler's Third Law (T¬≤ ‚àù a¬≥) was published in Harmonices Mundi (1619) and laid the mathematical foundation for Newton's Universal Law of Gravitation."
    ],
    isHtmlApp: true,
  ...
  },
  {
    ...
    features: [
      ...
      "Interactive vector phasor diagram illustrating voltage components (VR, VL, VC, Vtotal) and phase angle œï",
    ...
    sampleChallenges: [
      ...
      },
      {
        ...
        instruction: "Configure an RL or RLC circuit where inductive reactance exceeds resistance such that the phase angle œï reaches +45¬∞.",
        targetMetric: "Phase Angle (œï)",
        targetValue: 45,
        tolerance: 2,
        currentValueKey: "phi",
    ...
    previewFacts: [
      "In pure inductive circuits, voltage leads current by 90¬∞ (+œÄ/2 rad); in pure capacitive circuits, voltage lags current by 90¬∞ (-œÄ/2 rad).",
  ...
  },
  {
    ...
    learningObjectives: [
      "Analyze how changing magnetic flux through a rotating coil induces an alternating electromotive force (EMF = NBAœâ sin(œât))",
...
<body>
  ...
  },
  {
    ...
    tagline: "Explore wave-particle duality, frequency scaling, photon wavelength metrics, and Planck energy quantization (E = hŒΩ)",
    discipline: "physics",
    gradeLevel: ["High School (9-12)", "AP / IB STEM", "Undergraduate"],
    ...
    learningObjectives: [
      "Relate wavelength, frequency, and photon energy through c = ŒªŒΩ and E = hŒΩ",
    ...
    previewFacts: [
      "Higher frequency electromagnetic waves carry higher photon energy according to E = hŒΩ (Planck's relation)",
...
<body>
  ...
  },
  {
    ...
    learningObjectives: [
      "Verify that period T = 2œÄ‚àö(m/k) for spring-mass oscillators",
  ...
  },
  {
    ...
    learningObjectives: [
      "Demonstrate that buoyant force equals the weight of the fluid displaced (Fb = œÅ * V * g)",
  ...
  },
  {
    ...
    description: "Direct laser light rays through glass prisms, water, and optical media. Measure incident and refracted angles, verify Snell's Law (n1*sinŒ∏1 = n2*sinŒ∏2), and explore total internal reflection.",
    learningObjectives: [
...
<body>
  ...
  <div class="telemetry-grid">
    <div class="metric-card highlight">
      <span class="metric-label">Launch Height (h‚ÇÄ)</span>
  ...
  <div class="controls-panel">
    <div class="controls-title">
      ...
      <span style="color:#10b981;font-family:monospace;font-size:10px;">h‚ÇÄ decoupled from v‚ÇÄ</span>
    </div>
    <div class="controls-grid">
      ...
      <div class="control-row">
        <div class="control-header">
          <span>Launch Platform Height (h‚ÇÄ)</span>
  ...
  <div class="btn-toolbar">
    <div class="btn-group">
      <button class="btn-primary" id="btnLaunch">‚ñ∂ Launch Trajectory</button>
      <button class="btn-secondary" id="btnReset">‚Ü∫ Reset Lab</button>
    </div>
  </div>
  ...
  <script>
    ...
    function launch() {
      ...
      btnLaunch.innerText = "‚ñ∂ In Flight...";
      ...
      function step() {
        ...
        if (state.y <= 0 && state.t > 0.04) {
          ...
          state.isPlaying = false;
          btnLaunch.innerText = "‚ñ∂ Launch Trajectory";
  ...
  },
  {
    ...
    description: "Launch and synchronize communication satellites into Earth orbits. Calculate orbital periods using Kepler's Third Law (T^2 ‚àù r^3), maintain geostationary synchronization, and calculate signal transmission latency.",
    learningObjectives: [
      "Calculate orbital velocity v = ‚àö(GM/r) for circular orbits at arbitrary altitudes",
  ...
  },
  {
    ...
    learningObjectives: [
      "Verify that angle of incidence equals angle of reflection (Œ∏i = Œ∏r)",
  ...
  },
  {
    ...
    description: "Experiment with balance beams and seesaws. Place variable masses at graduated distances from the central fulcrum to demonstrate that for rotational equilibrium, Clockwise Moments = Counterclockwise Moments (Œ£œÑ = 0).",
    learningObjectives: [
      "Calculate torque œÑ = F * d (perpendicular force multiplied by lever arm distance)",
      "Apply the principle of moments to solve for unknown weights and distances",
      "Identify conditions for translational (Œ£F = 0) and rotational (Œ£œÑ = 0) static equilibrium"
    ],
  ...
  },
  {
    ...
    previewFacts: [
      ...
      "The back bearing of heading Œ∏ is (Œ∏ + 180¬∞) if Œ∏ < 180¬∞, and (Œ∏ - 180¬∞) if Œ∏ ‚â• 180¬∞"
    ],
    isHtmlApp: true,
  ...
  },
  {
    ...
    description: "Measure inaccessible heights (lighthouses, mountain peaks, towers) using clinometer angles of elevation and depression. Apply tan(Œ∏) = Opposite/Adjacent right-triangle ratios with observer eye-level compensation.",
    learningObjectives: [
    ...
    previewFacts: [
      ...
      "Tangent ratio tan(Œ∏) = opposite/adjacent is the primary trigonometric function for height surveying"
    ],
    isHtmlApp: true,
  ...
  },
  {
    ...
    tagline: "Mechanical Advantage (MA), Velocity Ratio (VR), Efficiency (Œ∑), Load Forces, and 3D Dynamic Winding Ropes",
    discipline: "physics",
    gradeLevel: ["Middle School (6-8)", "High School (9-12)", "AP / IB STEM"],
    standards: ["HS-PS3-3", "MS-PS3-5", "AP Physics 1 (Rotational Dynamics)"],
    description: "Investigate simple machines in full 3D. Control wheel and axle radii, adjust load mass, pull the rope to wind the coiled cables dynamically, and calculate Mechanical Advantage, Velocity Ratio (VR = R/r), Load Force (L = mg), and system Efficiency (Œ∑).",
    learningObjectives: [
      "Determine Velocity Ratio as the ratio of wheel radius to axle radius (VR = R/r)",
      "Calculate Mechanical Advantage (MA = Load / Effort) and mechanical efficiency Œ∑ = (MA / VR) √ó 100%",
...
<body>
  ...
  <script>
    ...
    function updateCalculations() {
      ...
      document.getElementById('calc-load').innerText = params.loadMass + ' √ó 9.81';
      ...
      document.getElementById('calc-eff').innerText = '(' + MA.toFixed(2) + ' / ' + VR.toFixed(2) + ') √ó 100';
  ...
  },
  {
    ...
    learningObjectives: [
      ...
      "Simulate the Meter Bridge slide-wire experiment and calculate unknown resistance X = R √ó (100 - l) / l",
...
<body>
    ...
    <div id="wheatstone-sim" class="sim-container active">
        ...
        <div class="control-card">
            ...
            <div class="control-group">
                <div class="control-header">Resistor P: <span id="ws-p-val" class="val">100 Œ©</span></div>
                <input type="range" id="ws-p" min="10" max="500" value="100">
            </div>

            <div class="control-group">
                <div class="control-header">Resistor Q: <span id="ws-q-val" class="val">100 Œ©</span></div>
                <input type="range" id="ws-q" min="10" max="500" value="100">
            </div>

            <div class="control-group">
                <div class="control-header">Variable Resistor R: <span id="ws-r-val" class="val">50 Œ©</span></div>
                <input type="range" id="ws-r" min="1" max="500" value="50">
            </div>

            <div class="formula-box">
                <div class="math-eq">Balance Ratio: P/Q = R/S ‚Üí S = R √ó (Q/P)</div>
    ...
    <div id="meter-sim" class="sim-container">
        ...
        <div class="control-card">
            ...
            <div class="control-group">
                <div class="control-header">Resistance Box (R): <span id="mb-r-val" class="val">10 Œ©</span></div>
            ...
            <div class="formula-box">
                <div class="math-eq">Formula: X = R √ó (100 - l) / l</div>
                <div>Known R = <span id="mb-disp-r">10</span> Œ©</div>
    ...
    <script>
        ...
        function renderWheatstone() {
            ...
            document.getElementById('ws-p-val').textContent = P + ' Œ©';
            document.getElementById('ws-q-val').textContent = Q + ' Œ©';
            document.getElementById('ws-r-val').textContent = R + ' Œ©';
            ...
            if (isBalanced) {
                ...
                calcSEl.textContent = calculated_S + " Œ©";
            ...
            // Resistors
            drawResistorSymbol(wsCtx, left.x, left.y, top.x, top.y, false, "Resistor P", P + " Œ©", "#38bdf8");
            drawResistorSymbol(wsCtx, top.x, top.y, right.x, right.y, false, "Resistor Q", Q + " Œ©", "#38bdf8");
            drawResistorSymbol(wsCtx, left.x, left.y, bottom.x, bottom.y, true, "Variable R", R + " Œ©", "#22c55e");
            drawResistorSymbol(wsCtx, bottom.x, bottom.y, right.x, right.y, false, "Unknown S", isBalanced ? calculated_S + " Œ©" : "S (Unknown)", isBalanced ? "#22c55e" : "#ef4444");
        ...
        function renderMeterBridge() {
            ...
            document.getElementById('mb-r-val').textContent = R + ' Œ©';
            ...
            // Resistors
            drawResistorSymbol(mbCtx, 170, 140, 230, 140, true, "Resistance Box (R)", R + " Œ©", "#22c55e");
            drawResistorSymbol(mbCtx, 370, 140, 430, 140, false, "Unknown (X)", isBalanced ? calc_X + " Œ©" : "X (Unknown)", isBalanced ? "#22c55e" : "#ef4444");
        ...
        function generatePDFWorksheet() {
            ...
            doc.text('‚Ä¢ Assigned Unknown S (Wheatstone): Determine value near target ~' + targetUnknownS + ' Œ©.', 16, y);
            y += 5;
            doc.text('‚Ä¢ Assigned Unknown X (Meter Bridge): Determine value near target ~' + targetUnknownX + ' Œ©.', 16, y);
            y += 5;
            doc.text('‚Ä¢ Balance Condition Equations: (P / Q) = (R / S)   and   X = R √ó (100 - l) / l', 16, y);
            ...
            doc.text('Resistor P (Œ©)', 42, y + 5);
            doc.text('Resistor Q (Œ©)', 78, y + 5);
            doc.text('Variable R (Œ©)', 114, y + 5);
            doc.text('Calculated S (Œ©)', 150, y + 5);
            ...
            doc.setFontSize(8.5);
            doc.text('Trial #', 18, y + 5);
            doc.text('Known Box R (Œ©)', 38, y + 5);
            doc.text('Null Length l (cm)', 75, y + 5);
            doc.text('(100 - l) (cm)', 115, y + 5);
            doc.text('Unknown X (Œ©)', 152, y + 5);
  ...
  },
  {
    ...
    description: "Master quadratic functions y = ax¬≤ + bx + c with interactive step-by-step point substitution, smooth curve tracing, automated axis of symmetry and vertex (max/min) calculations, right-angled triangle tangent gradient measurements (Rise/Run = Œîy/Œîx), and coordinate reader projections.",
    learningObjectives: [
      ...
      "Determine tangent line gradients using the geometric right-angled triangle method (m = Œîy/Œîx = Rise/Run)",
...
<body>
    ...
    <div class="container">
        ...
        <div class="panel">
            ...
            <div class="controls-group">
                <button class="primary" onclick="generateRandomFunction()">üé≤ New Random Graph</button>
                <button id="calcNextBtn" onclick="calculateNextYValue()">‚ö° Calculate Next y</button>
            </div>
            ...
            <div class="controls-group">
                <button class="success" id="plotBtn" onclick="plotNextPoint()">üìç Plot Point (<span id="plottedCount">0</span>/<span id="totalCount">7</span>)</button>
                <button class="success" id="curveBtn" onclick="drawCurveAnimation()" disabled>üìà Join Points (Curve)</button>
            </div>

            <!-- Dynamic Max/Min Value Card -->
            <div class="feature-card vertex-card">
                <div class="feature-title" style="color:var(--accent-amber);">
                    <span>üìå Maximum / Minimum Value (Vertex)</span>
            ...
            <div class="feature-card gradient-card">
                <div class="feature-title" style="color:var(--accent-purple);">
                    <span>üìê Tangent Gradient (Right-Angled Triangle Method)</span>
                    <label class="toggle-label">
            ...
            <div class="feature-card" style="border-color: var(--accent-blue);">
                <div class="feature-title" style="color:var(--accent-blue);">
                    <span>‚è±Ô∏è Curve Trace Speed</span>
            ...
            <div class="feature-card reader-card">
                <div class="feature-title" style="color:var(--accent-pink);">
                    <span>üîé Interactive Graph Reader</span>
        ...
        <div class="panel">
            ...
            <div class="feature-card calc-card">
                <div class="feature-title" style="color:var(--accent-green);">
                    <span>üßÆ Step-by-Step Substitution</span>
                </div>
    ...
    <script>
        ...
        function calculateVertexData() {
            ...
            const typeStr = isMin ? "MINIMUM (‚à™ Shape)" : "MAXIMUM (‚à© Shape)";
        ...
        function updateGradient() {
            ...
            html += '‚Ä¢ Lower Point (<em>x</em><sub>1</sub>, <em>y</em><sub>1</sub>) = (' + x1_tri.toFixed(2) + ', ' + y1_tri.toFixed(2) + ')<br>';
            html += '‚Ä¢ Upper Point (<em>x</em><sub>2</sub>, <em>y</em><sub>2</sub>) = (' + x2_tri.toFixed(2) + ', ' + y2_tri.toFixed(2) + ')<br>';
            html += '‚Ä¢ Vertical Change (&Delta;<em>y</em>) = <em>y</em><sub>2</sub> &minus; <em>y</em><sub>1</sub> = ' + y2_tri.toFixed(2) + ' &minus; (' + y1_tri.toFixed(2) + ') = <strong>' + rise.toFixed(2) + '</strong><br>';
            html += '‚Ä¢ Horizontal Change (&Delta;<em>x</em>) = <em>x</em><sub>2</sub> &minus; <em>x</em><sub>1</sub> = ' + x2_tri.toFixed(2) + ' &minus; (' + x1_tri.toFixed(2) + ') = <strong>' + run.toFixed(2) + '</strong><br>';
...
<div class="container">
    ...
    <div class="canvas-container" id="canvas-wrapper">
        <div class="canvas-hint">üåê Drag to rotate | Scroll to scale</div>
...
const GROUPS = {
    ...
    'CH3':    { name: 'Methyl (-CH‚ÇÉ)', label: '-CH‚ÇÉ', color: '#f43f5e', valence: 1, priority: 1, type: 'prefix', prefixName: 'methyl' },
    'C2H5':   { name: 'Ethyl (-C‚ÇÇH‚ÇÖ)', label: '-C‚ÇÇH‚ÇÖ', color: '#fb7185', valence: 1, priority: 1, type: 'prefix', prefixName: 'ethyl' },
    'C3H7':   { name: 'Propyl (-C‚ÇÉH‚Çá)', label: '-C‚ÇÉH‚Çá', color: '#f472b6', valence: 1, priority: 1, type: 'prefix', prefixName: 'propyl' },
    'C4H9':   { name: 'Butyl (-C‚ÇÑH‚Çâ)', label: '-C‚ÇÑH‚Çâ', color: '#fda4af', valence: 1, priority: 1, type: 'prefix', prefixName: 'butyl' },
    'C5H11':  { name: 'Pentyl (-C‚ÇÖH‚ÇÅ‚ÇÅ)', label: '-C‚ÇÖH‚ÇÅ‚ÇÅ', color: '#fecdd3', valence: 1, priority: 1, type: 'prefix', prefixName: 'pentyl' },
    ...
    'OCH3':   { name: 'Methoxy (-OCH‚ÇÉ)', label: '-OCH‚ÇÉ', color: '#d97706', valence: 1, priority: 2, type: 'prefix', prefixName: 'methoxy' },
    'OC2H5':  { name: 'Ethoxy (-OC‚ÇÇH‚ÇÖ)', label: '-OC‚ÇÇH‚ÇÖ', color: '#f59e0b', valence: 1, priority: 2, type: 'prefix', prefixName: 'ethoxy' },
    'OPh':    { name: 'Phenoxy (-OC‚ÇÜH‚ÇÖ)', label: '-OPh', color: '#b45309', valence: 1, priority: 2, type: 'prefix', prefixName: 'phenoxy' },
    'COOCH3':  { name: 'Carbomethoxy (-COOCH‚ÇÉ)', label: 'COOCH‚ÇÉ', color: '#10b981', valence: 1, priority: 9, type: 'prefix', prefixName: 'methoxycarbonyl' },
    'COOC2H5': { name: 'Carboethoxy (-COOC‚ÇÇH‚ÇÖ)', label: 'COOC‚ÇÇH‚ÇÖ', color: '#059669', valence: 1, priority: 9, type: 'prefix', prefixName: 'ethoxycarbonyl' },
    ...
    'NH2':    { name: 'Amino (-NH‚ÇÇ)', label: 'NH‚ÇÇ', color: '#3b82f6', valence: 1, priority: 4, type: 'suffix', suffixName: 'amine', prefixName: 'amino' },
...
function evaluateIUPAC() {
    ...
    if (!valenceCheck.valid) {
        return { 
            valid: false, 
            errorMessage: '‚ö†Ô∏è Invalid Structure: C' + valenceCheck.errorCarbon + ' has ' + valenceCheck.count + ' bonds (Max: 4)' 
        };
    }
...
resizeCanvas();
  ...
  },
  {
    ...
    learningObjectives: [
      ...
      "Calculate exact volumes of paraboloids, ellipsoids, hyperboloids, and cones using definite disk integrals V = ‚à´ œÄ[r(t)]¬≤ dt",
...
<body>
  ...
  <div id="main-container">
    ...
    <div id="explanation-modal" class="modal-backdrop">
      <div class="modal-content">
        <div class="modal-header">
          <h3>üìò Student Integration Guide: Dynamic Variable Breakdown</h3>
  ...
  <div id="sidebar">
    ...
    <div style="display: flex; gap: 8px;">
      <button id="btn-random" style="flex:1;">üé≤ Random Conic</button>
      <button id="btn-explain" class="btn-explain" style="flex:1.2;">üìò Explain Integration</button>
    </div>
    ...
    <div class="control-group">
      <label>Lower Bound (t‚ÇÅ): <span id="val-t1">0.0</span></label>
      <input type="range" id="param-t1" min="-5" max="5" step="0.2" value="0.0">
    </div>

    <div class="control-group">
      <label>Upper Bound (t‚ÇÇ): <span id="val-t2">4.0</span></label>
    ...
    <div class="math-card">
      <div class="math-card-header">üìê Definite Integration Formula</div>
  ...
  <script>
    ...
    function updateMathUI(riemannSum, tMin, tMax) {
      ...
      document.getElementById('chart-limits-text').innerText = 
        'Integral Bounds [' + v + '‚ÇÅ = ' + b1 + ', ' + v + '‚ÇÇ = ' + b2 + ']';
    }
    ...
    function openExplanationModal() {
      ...
      let html = 
        ...
        '<div class="var-grid">' +
          ...
          '<div class="var-card"><strong>Lower Bound (' + v + '‚ÇÅ):</strong> ' + t1.toFixed(2) + '</div>' +
          '<div class="var-card"><strong>Upper Bound (' + v + '‚ÇÇ):</strong> ' + t2.toFixed(2) + '</div>' +
          '<div class="var-card"><strong>Integration Span (Œît):</strong> ' + (t2 - t1).toFixed(2) + ' units</div>' +
          ...
          '<div class="var-card"><strong>Disk Thickness (d' + v + ' / Œî' + v + '):</strong> ' + dt.toFixed(3) + ' units</div>' +
        '</div>' +
        '<h4>2. How the Definite Integral is Formed</h4>' +
        '<p>When revolving a function <em>r(' + v + ')</em> around an axis, each thin slice forms a circular or elliptical disk of cross-sectional area <strong>A(' + v + ') = œÄ ¬∑ r(' + v + ')¬≤</strong>. Summing an infinite number of these infinitely thin disks between ' + v + '‚ÇÅ and ' + v + '‚ÇÇ gives the total volume:</p>' +
        '<div style="background:#020617; padding:10px; border-radius:6px; border:1px solid #334155; text-align:center;">' +
          '<em>V = ‚à´<sub>' + v + '‚ÇÅ</sub><sup>' + v + '‚ÇÇ</sup> A(' + v + ') d' + v + ' = ‚à´<sub>' + t1.toFixed(1) + '</sub><sup>' + t2.toFixed(1) + '</sup> œÄ [r(' + v + ')]^2 d' + v + '</em>' +
        '</div>' +
      ...
      switch(type) {
        case 'paraboloid':
          html += 
            '<p><strong>Radius Function:</strong> r(' + v + ') = ' + a.toFixed(1) + '‚àö' + v + '</p>' +
            '<p><strong>Step 1 (Square Radius):</strong> [r(' + v + ')]¬≤ = ' + (a*a).toFixed(2) + v + '</p>' +
            '<p><strong>Step 2 (Set Up Integral):</strong> V = œÄ ‚à´<sub>' + t1.toFixed(1) + '</sub><sup>' + t2.toFixed(1) + '</sup> ' + (a*a).toFixed(2) + v + ' d' + v + ' = ' + (Math.PI * a * a).toFixed(2) + ' [ ' + v + '¬≤/2 ]<sub>' + t1.toFixed(1) + '</sub><sup>' + t2.toFixed(1) + '</sup></p>' +
            '<p><strong>Step 3 (Evaluate Limits):</strong> V = <strong>' + exactVol.toFixed(4) + ' u¬≥</strong></p>';
          break;
        case 'ellipsoid':
          html += 
            '<p><strong>Radius Function:</strong> r(' + v + ') = ' + a.toFixed(1) + ' ¬∑ ‚àö(1 - ' + v + '¬≤ / 9)</p>' +
            '<p><strong>Step 1 (Square Radius):</strong> [r(' + v + ')]¬≤ = ' + (a*a).toFixed(2) + ' ¬∑ (1 - ' + v + '¬≤ / 9)</p>' +
            '<p><strong>Step 2 (Set Up Integral):</strong> V = ' + (Math.PI * a * a).toFixed(2) + ' ‚à´<sub>' + t1.toFixed(1) + '</sub><sup>' + t2.toFixed(1) + '</sup> (1 - ' + v + '¬≤ / 9) d' + v + '</p>' +
            '<p><strong>Step 3 (Evaluate Limits):</strong> Volume = <strong>' + exactVol.toFixed(4) + ' u¬≥</strong></p>';
          break;
        case 'hyperboloid':
          html += 
            '<p><strong>Radius Function:</strong> r(' + v + ') = ' + a.toFixed(1) + ' ¬∑ ‚àö(1 + ' + v + '¬≤ / 4)</p>' +
            '<p><strong>Step 1 (Square Radius):</strong> [r(' + v + ')]¬≤ = ' + (a*a).toFixed(2) + ' ¬∑ (1 + ' + v + '¬≤ / 4)</p>' +
            '<p><strong>Step 2 (Set Up Integral):</strong> V = ' + (Math.PI * a * a).toFixed(2) + ' ‚à´<sub>' + t1.toFixed(1) + '</sub><sup>' + t2.toFixed(1) + '</sup> (1 + ' + v + '¬≤ / 4) d' + v + '</p>' +
            '<p><strong>Step 3 (Evaluate Limits):</strong> Volume = <strong>' + exactVol.toFixed(4) + ' u¬≥</strong></p>';
          break;
        case 'cone':
          const slope = 0.6 * a;
          html += 
            ...
            '<p><strong>Step 2 (Set Up Integral):</strong> V = œÄ ‚à´<sub>' + t1.toFixed(1) + '</sub><sup>' + t2.toFixed(1) + '</sup> ' + (slope*slope).toFixed(4) + v + '¬≤ d' + v + '</p>' +
            '<p><strong>Step 3 (Evaluate Limits):</strong> Volume = <strong>' + exactVol.toFixed(4) + ' u¬≥</strong></p>';
          break;
      }
      ...
      html += 
        ...
        '<p>Instead of continuous integration, the computer calculates <strong>N = ' + N + '</strong> discrete cylindrical disks of thickness <strong>Œî' + v + ' = ' + dt.toFixed(3) + '</strong>. As you increase N, the discrete sum converges toward the exact analytical volume.</p>';
    ...
    function draw2DProfileChart(tMin, tMax, colorHex) {
      ...
      ctx.fillText('t‚ÇÅ = ' + tMin.toFixed(1), mapX(tMin) - 15, ch - 8);
      ctx.fillText('t‚ÇÇ = ' + tMax.toFixed(1), mapX(tMax) - 15, ch - 8);
    ...
    function updateOverlayLabels() {
      ...
      lblH.innerText = 'Bounds Span Œît = ' + span.toFixed(1);
  ...
  },
  {
    ...
    learningObjectives: [
      ...
      "Quantify the relationship between temperature differential (ŒîT) and surface wind velocity"
    ],
    ...
    features: [
      ...
      "Independent land (10¬∞C to 45¬∞C) and sea (10¬∞C to 35¬∞C) temperature sliders with real-time ŒîT calculations",
    ...
    sampleChallenges: [
      {
        ...
        instruction: "Switch to Daytime mode and increase Land Temp to 40¬∞C while keeping Sea Temp at 20¬∞C to achieve a ŒîT of +20¬∞C.",
        targetMetric: "Temperature Differential (ŒîT)",
        targetValue: 20.0,
        tolerance: 0.0,
...
<body>
    ...
    <div class="container">
        ...
        <div class="controls-panel">
            ...
            <div class="panel-section">
                ...
                <div class="telemetry-grid">
                    <div class="telemetry-card">
                        <div class="label">Temp Delta (ŒîT)</div>
            ...
            <button id="btnExplain" class="btn-info">üìñ Explain Science & Physics</button>
    ...
    <script>
        ...
        function updateTelemetry() {
            ...
            if (deltaT > 0) {
                windDirValue.innerText = 'Onshore (Sea ‚Üí Land)';
                cellTypeValue.innerText = 'Sea Breeze';
                tempDeltaValue.style.color = '#ef4444';
            } else if (deltaT < 0) {
                windDirValue.innerText = 'Offshore (Land ‚Üí Sea)';
  ...
  },
  {
    ...
    features: [
      "Resistor network topology toggling between Series and Parallel with 1 to 4 customizable resistors (1Œ© to 100Œ©)",
...
<body>
        ...
        <div class="control-panel">
            ...
            <div class="panel-section">
                ...
                <div class="control-group" id="r1Group">
                    <label>Resistor 1 (R‚ÇÅ): <span id="r1Val" class="val-tag">10 Œ©</span></label>
                    <input type="range" id="r1Slider" min="1" max="100" value="10" step="1" oninput="updateParams()">
                </div>

                <div class="control-group" id="r2Group">
                    <label>Resistor 2 (R‚ÇÇ): <span id="r2Val" class="val-tag">20 Œ©</span></label>
                ...
                <div class="control-group" id="r3Group" style="display: none;">
                    <label>Resistor 3 (R‚ÇÉ): <span id="r3Val" class="val-tag">30 Œ©</span></label>
                ...
                <div class="control-group" id="r4Group" style="display: none;">
                    <label>Resistor 4 (R‚ÇÑ): <span id="r4Val" class="val-tag">40 Œ©</span></label>
            ...
            <div class="panel-section">
                ...
                <div class="control-group">
                    <label>Bulb Filament Resistance: <span id="loadVal" class="val-tag">10 Œ©</span></label>
        ...
        <div class="workspace">
            ...
            <div class="summary-bar">
                ...
                <div class="summary-item">
                    ...
                    <span id="reqDisplay" class="summary-value">40.00 Œ©</span>
                </div>
                <div class="summary-item">
    ...
    <script>
        ...
        function updateParams() {
            ...
            document.getElementById('r1Val').textContent = \`\${R1} Œ©\`;
            document.getElementById('r2Val').textContent = \`\${R2} Œ©\`;
            document.getElementById('r3Val').textContent = \`\${R3} Œ©\`;
            document.getElementById('r4Val').textContent = \`\${R4} Œ©\`;
            document.getElementById('loadVal').textContent = \`\${R_load} Œ©\`;
            ...
            document.getElementById('reqDisplay').textContent = \`\${Req.toFixed(2)} Œ©\`;
        ...
        function drawRealisticBulb(x, y, current, loadR) {
            ...
            ctx.font = 'bold 11px sans-serif';
            ctx.textAlign = 'center';
            ctx.fillText(\`Bulb (\${R_load}Œ©)\`, 0, 42);
        ...
        function drawSeriesResistors(left, right, top) {
            ...
            let rList = [
                { name: 'R‚ÇÅ', val: \`\${R1}Œ©\`, v: V1 },
                { name: 'R‚ÇÇ', val: \`\${R2}Œ©\`, v: V2 },
                { name: 'R‚ÇÉ', val: \`\${R3}Œ©\`, v: V3 },
                { name: 'R‚ÇÑ', val: \`\${R4}Œ©\`, v: V4 }
            ];
        ...
        function drawParallelResistors(left, right, top, bottom) {
            ...
            let rList = [
                { name: 'R‚ÇÅ', val: \`\${R1}Œ©\`, current: I1 },
                { name: 'R‚ÇÇ', val: \`\${R2}Œ©\`, current: I2 },
                { name: 'R‚ÇÉ', val: \`\${R3}Œ©\`, current: I3 },
                { name: 'R‚ÇÑ', val: \`\${R4}Œ©\`, current: I4 }
            ];
  ...
  },
  {
    ...
    learningObjectives: [
      ...
      "Calculate total thickness (Total = MSR + CSR √ó 0.01 mm) for physical specimens clamped in the spindle gap",
...
<script>
  ...
  },
  {
    ...
    description: "Interact with 2-set and 3-set Venn diagrams in real time. Configure Universal set (U), Set A, Set B, and Set C elements, execute set operations (A ‚à™ B, A ‚à© B, A - B, B - A, A', B', and triple sets A ‚à™ B ‚à™ C, A ‚à© B ‚à© C, A - (B ‚à™ C)), inspect individual atomic regions with locked highlighting, and calculate exact cardinalities.",
    learningObjectives: [
      "Define universal sets, subsets, disjoint sets, and calculate the cardinality |S| of arbitrary set combinations",
      "Visualize and evaluate union (‚à™), intersection (‚à©), set difference (-), and absolute complement (') operations",
    ...
    sampleChallenges: [
      {
        ...
        instruction: "Select the Disjoint Sets preset and verify that the intersection A ‚à© B yields the empty set ‚àÖ with cardinality 0.",
      ...
      },
      {
        ...
        instruction: "In 3-set mode, find the elements belonging exclusively to the triple intersection A ‚à© B ‚à© C.",
    ...
    previewFacts: [
      ...
      "De Morgan's Laws state that (A ‚à™ B)' = A' ‚à© B' and (A ‚à© B)' = A' ‚à™ B', which are easily verified using Venn diagrams."
    ],
    isHtmlApp: true,
    htmlContent: `<!DOCTYPE html>
<html lang="en">
...
<body>
        ...
        <div class="panel">
            ...
            <div class="form-group">
                ...
                <select id="preset-select" onchange="applyPreset(this.value)">
                    ...
                    <option value="subset">Subset (A ‚äÜ B)</option>
                </select>
            </div>
            ...
            <button class="btn-random" onclick="generateRandomSets()">
                ‚ú® Generate Random Sets
            </button>

            <div class="panel-header" style="margin-top: 24px;">Set Operations</div>

            <div class="btn-group" id="op-buttons-2" style="display: none;">
                <button onclick="setOperation('A_UNION_B')" id="op-A_UNION_B">A ‚à™ B</button>
                <button onclick="setOperation('A_INTER_B')" id="op-A_INTER_B">A ‚à© B</button>
                ...
                <button onclick="setOperation('A_COMP')" id="op-A_COMP">A' (A·∂ú)</button>
                <button onclick="setOperation('B_COMP')" id="op-B_COMP">B' (B·∂ú)</button>
                <button onclick="setOperation('NONE')" id="op-NONE">Clear</button>
            </div>

            <div class="btn-group" id="op-buttons-3">
                <button onclick="setOperation('ABC_UNION')" id="op-ABC_UNION" class="active">A ‚à™ B ‚à™ C</button>
                <button onclick="setOperation('ABC_INTER')" id="op-ABC_INTER">A ‚à© B ‚à© C</button>
                <button onclick="setOperation('A_ONLY')" id="op-A_ONLY">A - (B ‚à™ C)</button>
    ...
    <script>
        ...
        const regionMetadata = {
            ...
            AB: { title: "Intersection A & B", notation: "A ‚à© B", desc: "Elements common to A and B." },
            outside: { title: "Exterior Universe", notation: "(A ‚à™ B)'", desc: "Elements in U outside A and B." },
            
            onlyA3: { title: "Set A Only", notation: "A - (B ‚à™ C)", desc: "Top-left area exclusive to Circle A." },
            onlyB3: { title: "Set B Only", notation: "B - (A ‚à™ C)", desc: "Top-right area exclusive to Circle B." },
            onlyC3: { title: "Set C Only", notation: "C - (A ‚à™ B)", desc: "Bottom area exclusive to Circle C." },
            AB3: { title: "Intersection A & B Only", notation: "(A ‚à© B) - C", desc: "Top-center overlap between A and B." },
            AC3: { title: "Intersection A & C Only", notation: "(A ‚à© C) - B", desc: "Mid-left overlap between A and C." },
            BC3: { title: "Intersection B & C Only", notation: "(B ‚à© C) - A", desc: "Mid-right overlap between B and C." },
            ABC3: { title: "Triple Intersection", notation: "A ‚à© B ‚à© C", desc: "Symmetric center region shared by A, B, and C." },
            outside3: { title: "Exterior Universe", notation: "(A ‚à™ B ‚à™ C)'", desc: "Elements in Universal set U outside all circles." }
        };
        ...
        function updateInspectorUI(key) {
            ...
            const elText = elements.length > 0 ? \`{ \${elements.join(', ')} }\` : '‚àÖ (Empty Set)';

            if (lockedRegionKey) {
                cardEl.classList.add('locked-card');
                tagEl.innerText = \`\${info.notation} [üîí Locked]\`;
            } else {
                cardEl.classList.remove('locked-card');
        ...
        function updateSimulation() {
            ...
            document.getElementById('result-set').innerText = resultSet.length > 0 ? \`{ \${resultSet.join(', ')} }\` : '‚àÖ (Empty Set)';
  ...
  },
  {
    ...
    learningObjectives: [
      ...
      "Calculate force multiplication using piston surface area ratios: F2 = P √ó A2 = F1 √ó (A2 / A1)",
      "Analyze the conservation of work (F1 √ó d1 = F2 √ó d2) and understand why high force multiplication requires multi-stroke pumping displacement to lift heavy loads"
    ],
    ...
    previewFacts: [
      ...
      "Because Work = Force √ó Distance is conserved, gaining a 10√ó force multiplication means the small piston must move 10√ó the distance of the large piston."
    ],
    isHtmlApp: true,
    htmlContent: `<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="container">
        ...
        <div class="controls-panel">
            ...
            <div class="calc-panel">
                ...
                <div>A1 = œÄ √ó (r1)¬≤ = <span id="calcA1">0.00283</span> m¬≤</div>
                <div>A2 = œÄ √ó (r2)¬≤ = <span id="calcA2">0.02011</span> m¬≤</div>
                <div>Pressure P = F1 / A1 = <span id="calcP" style="color: #4ade80;">53,051.6</span> N/m¬≤</div>
                <div>Output Force F2 = P √ó A2 = <span id="calcF2" style="color: #38bdf8;">1,066</span> N</div>
    ...
    <section class="physics-section">
        ...
        <div class="physics-grid">
            <div class="physics-card">
                ...
                <span class="formula">P‚ÇÅ = P‚ÇÇ = P</span>
            </div>

            <div class="physics-card">
                <h3>2. Force Multiplication</h3>
                <p>
                    Because pressure is equal to force divided by cross-sectional area, a small force applied on a smaller piston (A‚ÇÅ) creates fluid pressure that produces a much larger output force on a larger piston (A‚ÇÇ).
                </p>
                <span class="formula">F‚ÇÇ = P √ó A‚ÇÇ = F‚ÇÅ √ó (A‚ÇÇ / A‚ÇÅ)</span>
            </div>

            <div class="physics-card">
                <h3>3. Conservation of Work & Energy</h3>
                <p>
                    Force is multiplied at the expense of distance. Work input equals work output (W = F √ó d). The input piston must move a much greater distance (d‚ÇÅ) than the output piston moves (d‚ÇÇ).
                </p>
                <span class="formula">F‚ÇÅ √ó d‚ÇÅ = F‚ÇÇ √ó d‚ÇÇ</span>
            </div>
        </div>
    </section>
  ...
  },
  {
    ...
    description: "An interactive Cartesian coordinate virtual lab for exploring 2D rigid motions and non-rigid transformations: rotations around arbitrary pivot points, translations (Œîx, Œîy), reflections across standard axes, and dilations by scale factor k with animated mapping rules and coordinate matrices.",
    learningObjectives: [
      ...
      "Describe the effect of dilations, translations, rotations, and reflections on two-dimensional figures using coordinate algebraic rules like (x, y) ‚Üí (-y, x)",
      "Determine coordinates of image vertices given a pre-image, center of rotation (x‚ÇÄ, y‚ÇÄ), scale factor k, or line of reflection"
    ],
    thumbnailGradient: "from-sky-500 via-indigo-600 to-rose-600",
    ...
    features: [
      ...
      "4 Transformation Engines: Rotation (custom pivot & angles), Translation (Œîx, Œîy), Reflection (x-axis, y-axis, y=x, y=-x), and Dilation (scale factor k & center)",
    ...
    sampleChallenges: [
      {
        ...
        instruction: "Rotate the triangle 90¬∞ CCW about (0,0) and observe how coordinates map (x, y) ‚Üí (-y, x).",
  ...
  },
  {
    ...
    title: "Advanced Multi-Step Geometric Transformation Engine",
    tagline: "Compose multi-step sequences of rotations, translations, reflections, and matrix dilations with dynamic polygon coordinate transforms",
    discipline: "mathematics",
    gradeLevel: ["High School (9-12)", "AP / IB STEM"],
    standards: ["CCSS.MATH.CONTENT.HSG.CO.A.5", "CCSS.MATH.CONTENT.8.G.A.2", "CCSS.MATH.CONTENT.8.G.A.4"],
    description: "An advanced mathematical sandbox for chaining consecutive 2D geometric operations. Investigate non-commutative transformation compositions (e.g. R ‚àò T vs T ‚àò R), arbitrary axis reflections, glide reflections, and 2x2 transformation matrix determinants.",
    learningObjectives: [
      "Demonstrate that transformation composition is generally non-commutative by contrasting rotation-then-translation with translation-then-rotation",
      "Formulate composite transformation matrices and coordinate rules for multi-step operations",
      "Identify glide reflections and symmetry groups of regular planar geometric polygons"
    ],
    thumbnailGradient: "from-purple-600 via-indigo-700 to-pink-600",
    ...
    features: [
      "Multi-Step Pipeline: Chain up to 4 sequential transformations on pre-image polygons",
      "Interactive Step-by-Step Step Scrubbing with coordinate trajectory tracking",
      "Matrix Representation Display showing determinants and eigenvalues",
      "Preset challenge puzzles requiring reverse-engineering the transformation pipeline"
    ],
    parameterDefaults: {
      stepsCount: 2
    },
    parameterControls: [
      {
        ...
        step: 1,
        unit: "steps",
        description: "Number of chained transformation operations"
      }
    ],
    sampleChallenges: [
      {
        id: "ch-multistep-1",
        title: "Glide Reflection Alignment",
        instruction: "Construct a glide reflection by combining a reflection across the x-axis with a horizontal shift of Œîx = +4.",
        targetMetric: "Pipeline Steps",
        targetValue: 2,
        tolerance: 0,
        currentValueKey: "stepsCount",
        rewardBadge: "Glide Specialist"
      }
    ],
    previewFacts: [
      "A glide reflection is the only fundamental 2D isometry that cannot be simplified to a single pure rotation or reflection.",
      "The determinant of a rigid isometry transformation matrix is always either +1 (orientation-preserving) or -1 (orientation-reversing)."
    ],
    isHtmlApp: true,
    htmlUrl: "/simulations/geometric-transformations-rotation.html"
  },
  {
    ...
    title: "High-Precision Acid-Base Titration & pH Curve Analyzer",
    tagline: "Simulate volumetric acid-base titrations with buret drop control, Henderson-Hasselbalch equilibrium, indicators, and 1st/2nd derivative curves",
    discipline: "chemistry",
    gradeLevel: ["High School (9-12)", "AP / IB STEM", "Undergraduate"],
    standards: ["HS-PS1-2", "AP Chemistry (Unit 8)", "NGSS SEP-4", "NGSS SEP-5"],
    description: "A precision volumetric chemistry lab simulating titrations of strong and weak monoprotic/polyprotic acids and bases (HCl, CH‚ÇÉCOOH, H‚ÇÉPO‚ÇÑ with NaOH). Features drop-by-drop buret dispensing, dynamic pH curve generation, indicator color transitions, and mathematical derivative endpoint detection.",
    learningObjectives: [
      "Construct and interpret acid-base titration curves identifying buffer regions, half-equivalence points (pH = pKa), and equivalence points",
      "Apply the Henderson-Hasselbalch equation to calculate buffer capacity and resistance to pH changes",
      "Select appropriate chemical indicators (phenolphthalein, methyl orange, bromothymol blue) based on pKa and equivalence pH"
    ],
    thumbnailGradient: "from-teal-500 via-emerald-600 to-indigo-900",
    badgeColor: "bg-teal-500/10 text-teal-300 border-teal-500/20",
    ...
    features: [
      "Automated and manual dropwise buret burette dispensing with digital pH meter",
      "Polyprotic and monoprotic system options (HCl, Acetic Acid, Formic Acid, Ammonia)",
      "Dynamic Indicator Color Rendering showing continuous chromatic shift at transition pH",
      "1st and 2nd Derivative pH graphs to accurately pinpoint inflection equivalence volumes"
    ],
    parameterDefaults: {
      acidMolarity: 0.1,
      titrantSpeed: 1
    ...
    parameterControls: [
      {
        key: "acidMolarity",
        label: "Analyte Molarity",
        min: 0.01,
        max: 1.0,
        step: 0.01,
        unit: "M",
        description: "Initial concentration of acid solution"
      }
    ],
    sampleChallenges: [
      {
        id: "ch-titrate-1",
        title: "Locate Equivalence Point of Acetic Acid",
        instruction: "Titrate 25.0 mL of 0.10 M CH3COOH with 0.10 M NaOH to determine the precise equivalence volume and pH > 7.",
        targetMetric: "Equivalence Reached",
        targetValue: 25,
        tolerance: 0.2,
        currentValueKey: "titrantVolume",
        rewardBadge: "Titration Expert"
      }
    ],
    previewFacts: [
      "At the half-equivalence point in a weak acid titration, [HA] = [A‚Åª], meaning pH is exactly equal to the acid pKa.",
      "The equivalence point of a weak acid titrated with a strong base is always basic (pH > 7) due to conjugate base hydrolysis."
    ],
    isHtmlApp: true,
    htmlUrl: "/simulations/comprehensive-chemistry-workbench.html"
  },
  {
    ...
    title: "2D Momentum Conservation & Collision Physics Lab",
    tagline: "Explore elastic and inelastic collisions in two dimensions with velocity vectors, center-of-mass frame, and kinetic energy dissipation",
    discipline: "physics",
    gradeLevel: ["High School (9-12)", "AP / IB STEM"],
    standards: ["HS-PS2-1", "HS-PS2-2", "AP Physics 1 (Unit 5)", "NGSS SEP-5"],
    description: "An interactive 2D collision dynamics laboratory. Manipulate puck masses, initial velocity vectors, impact parameters, and coefficient of restitution (e = 0 to 1) to invesxú‹}[oG~Ôª?EA¿JCÏÙê3ºà‰B®!%
"%öCŸﬁFP”]3”VO˜∏´{»—¡${Äì»cÄ y8ÔÁmsNÄÚ®}∑øÉ?I˛ó™ÍÍôä¢∞Sdﬂ™∫˛∑ﬂˇV]ƒcY(f©V˘\qñäl$¶ŸT•E92çƒ€8UE
ï™|ºE.S= Ú)]≠;⁄ü	¯/Q2O„t¸z¯≠
ãxÆÙ°¯öŒÒ‡ï«£≈ 0	<YÊ’hq*ÜY174ÓBD1ú–8ä»’XÊQ¢¥∆U"5L).ft„ÛR¶é≤4ﬂ$”Zi|ˆLÂ#ò[≤Ä?Ã`JIÛsïÎR◊'	w≠^Yçyî dÒNUÁƒTÖô∆°£<õÚÎ%Œ‰0ÀeëÂxïë U*∏DNΩk@ÂA6
Œ%ºb´üùoÈ4÷7<d1)ß√T∆…Û\F1‹s(‡8¡0)U∞∑µ%Ê±¬ÖLÈè"tÙ∂∂Ã§á2´~ñd9‹:Ûµª[[õ]∏\›|`nÜ˘F0%wAœ>"Üz3É!•+*¿äùŒ¡∂9¢Ê±∫Óg%Nu˜±y%√â Õ—^wÀpPµ’’b∆èñëö¬∫ÆNŒEà†ÛVÙ°xë=äÈ#q∆wôÃr‡
ú¬ˇ0$“W¢ÆxƒC—=∞¥”·$Àíc5ìy1•ïÏmmŸìQ¨xRÒ&M‚i\®ﬁikãN˛ÅØ)Yîyç…èKòNÔÿcÜYæ’‚:K]d”¯ù&JL%±dk˙„ˇÆ-‡Á7à‚4.bx»\%27¸Àxw©‹ªùƒæìVräÇëŸåÈ,±_òMgâ*úB~Îs~K=Ÿ⁄ Òƒ¬;’›ïIPÄ,ö˘àH·É33íûd◊∞ ‚‚¶-.mzì´¨Ä˜8∑ÇΩÚ«ãT"q_Y=aYÇ6 ˘…›$nY‡5ø•'“Ø·[ï◊§H
